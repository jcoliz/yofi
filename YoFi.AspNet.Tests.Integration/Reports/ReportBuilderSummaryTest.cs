...
namespace YoFi.AspNet.Tests.Integration.Reports
{
    ...
    public class ReportBuilderSummaryTest: ReportBuilderTestBase
    {
        ...
        public async Task ReportsGet()
        {
            ...
            ThenReportHasTotal(report: "expenses", expected: -64522m);
            ThenReportHasTotal(report: "savings", expected: -34217m);
        }
        ...
        public async Task ReportsGetNewYear()
        {
            ...
            await WhenGettingReport(new ReportParameters() { slug = "summary", year = 2023 });
